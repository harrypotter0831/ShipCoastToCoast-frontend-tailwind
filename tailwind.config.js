  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'select-icon': `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23343a40' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M2 5l6 6 6-6'/%3e%3c/svg%3e")`,
      },
      boxShadow: {
        'input': '0 0 0 0.25rem rgb(13 110 253 / 25%)'
      }, 
      backgroundPosition: {
        'right-75': 'right .75rem center'
      }
    },
  },
  plugins: [],
