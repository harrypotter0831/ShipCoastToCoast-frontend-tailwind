            ...
            <div className="w-full flex flex-col">
                <div className="flex flex-wrap">
                    ...
                    <div className="flex flex-col w-full lg:w-1/2 bg-home-gradient p-6 md:p-12">
                        ...
                        <div className={`transition-all invisible opacity-0 hidden ${step === 1 ? "!visible !opacity-100 !block" : ""}`}>
                        ...
                        <div className={`transition-all invisible opacity-0 hidden ${step === 2 ? "!visible !opacity-100 !block" : ""}`}>
                            <h1 className="text-white text-[calc(1.475rem_+_2.7vw)] font-light leading-tight md:mb-8 md:mr-8">
                        ...
                        <div className={`transition-all invisible opacity-0 hidden ${step === 3 ? "!visible !opacity-100 !block" : ""}`}>
                            <h1 className="text-white text-[calc(1.475rem_+_2.7vw)] font-light leading-tight md:mb-8 md:mr-8">
